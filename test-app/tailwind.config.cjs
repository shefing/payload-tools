...
module.exports = {
  ...
  content: [
    ...
    '../packages/quickfilter/src/**/*.{js,ts,jsx,tsx}',
    '../packages/reset-list-view/src/**/*.{js,ts,jsx,tsx}',
    '../packages/icon-select/src/**/*.{js,ts,jsx,tsx}',
    '../packages/right-panel/src/**/*.{js,ts,jsx,tsx}',
    '../packages/comments/src/**/*.{js,ts,jsx,tsx}',
  ],
  theme: {
    container: {
      center: true,
